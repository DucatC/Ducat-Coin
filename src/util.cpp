...
int nAnonymizeDucatAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Ducat
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Ducat
    // Mac: ~/Library/Application Support/Ducat
    // Unix: ~/.Ducat
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Ducat";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Ducat.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "ducatd.pid"));
