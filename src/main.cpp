...
const string strMessageMagic = "Ducat Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    if (nHeight == 1){
      ...
      nSubsidy = 160000 * COIN;
    } else if (nHeight > 11 && nHeight <= 10000){
      nSubsidy = 0 * COIN;
    } else {
      nSubsidy = 0 * COIN;
    }
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    if(nBestHeight >= 300 && nBestHeight <= 2000){
      nSubsidy = 0.1 * COIN;
    } else if(nBestHeight > 2000 && nBestHeight < 50000){
      nSubsidy = 18 * COIN;
      ...
      nSubsidy = 75 * COIN;
    } else if(nBestHeight >= 300000 && nBestHeight < 350000){
      nSubsidy = 50 * COIN;
    } else if(nBestHeight >= 350000 && nBestHeight < 400000){
      nSubsidy = 25 * COIN;
    } else if(nBestHeight >= 400000 && nBestHeight < 450000){
      nSubsidy = 12 * COIN;
    } else if(nBestHeight >= 450000 && nBestHeight < 500000){
      nSubsidy = 6 * COIN;
    } else if(nBestHeight >= 500000 && nBestHeight < 550000){
      nSubsidy = 3 * COIN;
    } else{
      nSubsidy = 3 * COIN;
    }
